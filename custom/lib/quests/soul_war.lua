SoulWarQuest = {
	...
	ebbAndFlow = {
		...
		mapsPath = {
			empty = "custom/world/quest/soul_war/ebb_and_flow/ebb-flow-empty.otbm",
			inundate = "custom/world/quest/soul_war/ebb_and_flow/ebb-flow-inundate.otbm",
			ebbFlow = "custom/world/quest/soul_war/ebb_and_flow/ebb-flow.otbm",
		},
